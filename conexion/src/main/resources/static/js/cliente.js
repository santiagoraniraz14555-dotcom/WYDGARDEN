    ...
    function validateForm(event) {
        ...
        if (!startDate) {
            document.getElementById("startDateError").textContent = "Fecha requerida";
            isValid = false;
        }
    ...
    function editClient(button) {
        ...
        document.getElementById("startDate").value = editingRow.cells[3].textContent;
    }
    ...
    function updateClient(row) {
        ...
        row.cells[3].textContent = document.getElementById("startDate").value;
    }
